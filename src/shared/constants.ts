...
export const GITHUB_REPO = 'qiyuequkanhaiba/localharness'
export const GITHUB_RELEASES_URL = `https://github.com/${GITHUB_REPO}/releases`

export const AUTH_REQUIRED_TEXT = 'dsh web authentication required'

export const SHELL_ACTION_SCHEME = 'localharness'
...
export const ENGINE_SMOKE_TIMEOUT_MS = 90_000
