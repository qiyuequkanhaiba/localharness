...
|---|---|---|
| `0.1.0-rc.6` | `0.1.9` | Verified — shipped / pinned |
...
- `dsh web --host 127.0.0.1 --port 0` (and `--no-open` when the engine documents that flag)
- stdout line `dsh web: http://127.0.0.1:<port>` (newer official engines may append `/?token=…`)
